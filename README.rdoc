...
As described in the SM-2 algorithm, anything this is not recalled or recalled with difficulty should be repeated again at the end of the day's session. This method, based on the q value given for an item, determines whether it should be repeated.
