...
ef - The Easiness Factor of the item being recalled. The smaller the number the harder the item
    is to remember.
i - The scheduled Interval for the item to be recalled, in days. That is, how many days until the 
    item should be recalled to retain it. 
